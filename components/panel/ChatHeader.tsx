...
import { MoreVertical, ArrowLeft, Phone, ChevronRight } from "lucide-react";
  ...
  return (
    <>
      <div className="flex items-center gap-3 px-4 py-3 bg-card border-b border-border shadow-sm">
        ...
        {/* Clickable avatar + name → opens ContactSheet */}
        <button
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1">
              ...
              <ChevronRight size={12} className="text-muted-foreground flex-shrink-0 opacity-0 group-hover:opacity-100 transition-opacity" />
            </div>
